...
import playimg from '../../../assets/image/playing.png'

const DetailService = () => {
    return (
        <div className="px-6 md:px-28 mt-36 mb-8">
        <div className="grid md:grid-cols-3 grid-cols-1 gap-12">
          <div>
            <div className="flex bg-[#152F47] text-white my-4 px-5 justify-between w-72 text-[16px] font-normal items-center shadow-lg  py-2 rounded-lg">
              <p >
                <Link to="strategy">Purpose & Strategy</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Organisational Growth</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Marketing</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Human Resources</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Corporate Finance</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Compliancey</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Operations Effectiveness</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Mergers & Acquisitions</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
            ...
            <div className="flex my-4 px-5 justify-between w-72 text-[16px] font-normal items-center bg-white shadow-lg  py-2 rounded-lg">
              <p>
                <Link to="strategy">Governance</Link>
              </p>
              <p>
                <HiChevronRight />
              </p>
